      ...
      <Box borderRadius="10px" bgColor="gray.100" height="fit-content">
          ...
          >
            ...
            >
              <Text fontSize="0.9rem" fontWeight="500">
                {contextVal?.state.requisitionDetails?.requisitionTitle}
              </Text>
              <Flex justifyContent="space-around" alignItems="center">
                ...
                <Text fontSize="1rem" fontWeight="bold" as="span">
                  {contextVal?.state.requisitionDetails?.noOfOpenings}
                </Text>
              </Flex>
            </Flex>
          </Box>
        ...
        <Box maxH="50rem" overflowY="auto" px="24px" pb="24px">
            ...
            <KeyValue
              ...
              value={
                urgencyOptions.find(
                  (item) =>
                    item?.value ===
                    contextVal?.state.requisitionDetails?.urgency
                )?.label
              }
            />
            <KeyValue
              ...
              value={
                genderOptions.find(
                  (item) =>
                    item?.value === contextVal?.state.requisitionDetails?.gender
                )?.label
              }
            />
          </DataCard>
          <DataCard title="Job Detail">
            <KeyValue
              title="Job Title"
              value={contextVal?.state.jobDetails?.jobTitle}
            />
            <KeyValue
              title="Job Details"
              value={contextVal?.state.jobDetails?.jobDetails}
            />
            <KeyValue
              title="Job Location"
              value={contextVal?.state.jobDetails?.jobLocation}
            />
          </DataCard>
            ...
            <KeyValue
              ...
              value={
                interviewDurationOptions.find(
                  (item) =>
                    item?.value ===
                    contextVal?.state.interviewSettings?.interviewDuration
                )?.label
              }
            />
            <KeyValue
              ...
              value={
                interviewLanguageOptions.find(
                  (item) =>
                    item?.value ===
                    contextVal?.state.interviewSettings?.interviewLanguage
                )?.label
              }
            />
            <KeyValue
              ...
              value={
                interviewModeOptions.find(
                  (item) =>
                    item?.value ===
                    contextVal?.state.interviewSettings?.interviewMode
                )?.label
              }
            />
          </DataCard>
