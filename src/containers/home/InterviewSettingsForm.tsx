...
import useSetValues from "@src/hook/useSetValues";

const InterviewDetailsForm: React.FC<{
  handleTab: (n: PageNumbers) => void;
}> = ({ handleTab }) => {

  // custom hook to set values
  const { handleInterviewSettingsValue } = useSetValues();
  ...
  const {
    ...
    onSubmit: (values) => {
      handleInterviewSettingsValue(values);
